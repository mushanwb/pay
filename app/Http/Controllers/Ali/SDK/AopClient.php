...
namespace App\Http\Controllers\Ali\SDK;
...
class AopClient
{
    ...
    public function __construct($aliConfig) {
        $this->appId = $aliConfig['alipay_appid'];
        $this->rsaPrivateKey = $aliConfig['alipay_private_key'];
        $this->alipayrsaPublicKey = $aliConfig['alipay_public_key'];
    }
